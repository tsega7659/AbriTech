                            ...
                            >
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="text-right">
                                        <span className="text-xl font-black text-[#00B4D8]">{Math.round(course.progressPercentage !== undefined ? course.progressPercentage : course.progress || 0)}%</span>
                                    </div>
                                </div>
                                ...
                                <div className="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
                                    <div
                                        ...
                                        style={{ width: `${Math.round(course.progressPercentage !== undefined ? course.progressPercentage : course.progress || 0)}%` }}
                                    ></div>
                                </div>
